...
function LoginPageForWeb({ match }) {
  ...
  useEffect(() => {
    ...
    window.alert("스테이션아이디" + sessionStorage.getItem("stationId"));
    axios
        ...
        axios
          ...
          .then(
            axios.spread((firstRes, secondRes) => {
              // console.log(firstRes.data.id);
              // console.log(firstRes.data.kakao_account);
              // console.log(firstRes.data.kakao_account.has_phone_number);
              ...
              window.alert(firstRes.data.kakao_account.phone_number);
          ...
          .then((res) => {
            ...
            window.alert("스테이션아이디" + sessionStorage.getItem("userId"));
